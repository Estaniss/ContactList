...
import br.edu.scl.ifsp.sdm.contactlist.databinding.TileContentBinding
...
class ContactRvAdapter(private val contactList: MutableList<Contact>, private val onContactClickListener: OnContactClickListener ) : RecyclerView.Adapter<ContactRvAdapter.ContactViewHolder>(){
    inner class ContactViewHolder(tileContentBinding: TileContentBinding) : RecyclerView.ViewHolder(tileContentBinding.root)
    {
        val nameTv :TextView = tileContentBinding.nameTv
        val emailTv : TextView = tileContentBinding.emailTv
        val phoneTv : TextView = tileContentBinding.phoneTv

        init {
            tileContentBinding.root.apply {
                ...
                setOnClickListener { itemView.setOnClickListener { onContactClickListener.onContactClick(adapterPosition) } }
            }
        }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
        TileContentBinding.inflate(LayoutInflater.from(parent.context) ,parent,false).run {
